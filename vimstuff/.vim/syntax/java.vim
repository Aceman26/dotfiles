...
"Baseline
syn match javaBase_Class "\<\u[a-zA-Z0-9]*\>"
hi javaBase_Class ctermfg=216 guifg=#ffaf87 "rgb=255,175,135
syn match javaBase_Constants "\<[A-Z0-9][_A-Z0-9]*\>"
hi javaBase_Constants ctermfg=228 guifg=#ffff87 "rgb=255,175,135
...
syn keyword javaAssert		assert assertThat
...
if exists("java_highlight_all")  || exists("java_highlight_java")  || exists("java_highlight_java_lang")
  ...
  syn match javaX_MoreJavaExceptions "\U[a-zA-Z]*Exception\>"
  syn cluster javaTop add=javaX_MoreJavaExceptions
  syn cluster javaClasses add=javaX_MoreJavaExceptions
  hi def link javaX_MoreJavaExceptions javaX_Java
...
syn region  javaParenT	transparent matchgroup=javaParen  start="(" end=")" contains=@javaTop,javaParenT1,javaBase_Class,javaBase_Constants,javaClasses
syn region  javaParenT1 transparent matchgroup=javaParen1 start="(" end=")" contains=@javaTop,javaParenT2,javaBase_Class,javaBase_Constants,javaClasses contained
syn region  javaParenT2 transparent matchgroup=javaParen2 start="(" end=")" contains=@javaTop,javaParenT,javaBase_Class,javaBase_Constants,javaClasses  contained
